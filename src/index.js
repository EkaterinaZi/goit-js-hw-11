...
const KEY = '29206666-47f56dc34c806392fb43c0dc5';
...
const dataLibrary = async (inputValue) => {
  try{
const response = await axios.get(`${BASE_URL}?key=${KEY}&q=${inputValue}&image_type=photo&orientation=horizontal&safesearch=true&per_page=${perPage}&page=${page}`)
...
const generateContent = (array) => (array.reduce((acc, item) => acc + createGallery(item), ""));
